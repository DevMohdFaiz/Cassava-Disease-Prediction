...
try:
    best_trained_model = torch.load('models/best_cassava_model.pth', map_location=device, weights_only=False)
except: 
    best_trained_model = torch.load('best_cassava_model.pth', map_location=device, weights_only=False)
